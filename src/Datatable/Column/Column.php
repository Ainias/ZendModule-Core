...
class Column
{
    ...
    public function buildJsArray()
    {
        $array = array(
            ...
            "visible" => ($this->isHidden())?"false":"true",
    ...
    public function buildHeadCell($datatableName, $row)
    {
        $headCell = "<th id = '$datatableName"."_head_$row' ";
    ...
    public function setOptions(array $options)
    {
        ...
        isset($options["searchable"]) && $this->setSearchable($options["searchable"]);
        isset($options["responsivePriority"]) && $this->setResponsivePriority($options["responsivePriority"]);
    }
    ...
    /**
     * @param int $responsivePriority
     */
    public function setResponsivePriority(int $responsivePriority)
    {
